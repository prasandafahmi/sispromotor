	...
	<?php $this->load->view("layout/wrapper.php")?>	 
		<div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
					<div class="col-md-12">
                        <h4><i class="fa fa-database"></i>	Jasa Lab</h4>
	                  	<hr>
						...
						<table class="table table-striped table-advance table-hover">
		                    ...
		                    foreach($menunya->result() as $permenu){
                                echo "<tr>
                                  ...
                                  <td>$permenu->syarat</td>
                                   <td><a href='".site_url('super_admin/Jasalab/update/'.$permenu->id)."'>Ubah</a></td>
                                   <td><a  href='".site_url('super_admin/Jasalab/aksi_delete/'.$permenu->id)."'onclick='if(! confirm(\"yakin akan di hapus?\"))return false;''>Hapus</a></td>
					       </tr>";
                                    $i++;
		                  }
		                  ?>
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              ...
                                              <h4 class="modal-title">Jasa Lab</h4>
                                          </div>
                                          <div class="modal-body">
												<form action="<?php echo site_url("super_admin/Jasalab/aksi_insert"); ?>"  method="post" enctype="multipart/form-data">
												  ...
												  <div class="form-group">
                                                      ...
                                                      <textarea class="ckeditor" id="ckeditor" name="f4"></textarea>
                                                  </div>
												  <div class="form-group">
                                                      <label for="exampleInputharga1">Harga</label>
                                                      <input type="harga" class="form-control" id="exampleInputharga3" placeholder="Harga" name="f5">
                                                  </div>
