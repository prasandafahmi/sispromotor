...
<body>
                             ...
                             <h4 class="modal-title">Jasa Pustaka</h4>
                                          ...
                                          <div class="panel-body">
                                              <div class="table-responsive">
												...
												<form action="<?php echo site_url("super_admin/Jasapus/aksi_update"); ?>" method="post" enctype="multipart/form-data">
                                                     <?php
      $menu = $menuX->result();    
      //print_r($menuT);    
    ...
    ?>
												  ...
												  <div class="form-group">
                                                      ...
                                                      <input type="harga" value="<?php echo $menu[0]->harga ?>" placeholder="Harga" name="f4">
                                                  </div>
                                                     <div class="form-group">
                                                      <label for="exampleInputsyarat1">Syarat</label>
                                                      <textarea class="ckeditor" id="ckeditor" name="syarat"><?php echo $menu[0]->syarat ?></textarea>
                                                  </div>
