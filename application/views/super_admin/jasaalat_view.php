    ...
    <?php $this->load->view("layout/wrapper.php")?>
		<div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
					<div class="col-md-12">
                        <h4><i class="fa fa-database"></i>	Jasa Alat Lab</h4>
	                  	<hr>
		                    ...
		                    foreach($menunya->result() as $permenu){
                                echo "<tr>
                                  ...
                                  <td>Rp. $permenu->harga</td>
                                   <td><a href='".site_url('super_admin/Jasaalat/update/'.$permenu->id)."'>Ubah</a></td>
                                   <td><a  href='".site_url('super_admin/Jasaalat/aksi_delete/'.$permenu->id)."'onclick='if(! confirm(\"yakin akan di hapus?\"))return false;''>Hapus</a></td>
					       </tr>";
                                    $i++;
		                  }
		                  ?>
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
												<form action="<?php echo site_url("super_admin/Jasaalat/aksi_insert"); ?>"  method="post" enctype="multipart/form-data">
