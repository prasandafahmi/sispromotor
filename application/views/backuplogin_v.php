                                           ...
                                           <ul>
                                             ...
                                             <form action="<?php echo site_url(); ?>/Register/insert_user" method="POST" class="form-signin">
                                               ...
                                               <tr>
                                                   ...
                                                   <td width="65%"><input type="text"  value="<?php if( ($this->session->userdata('r_nama'))){ echo $this->session->userdata('r_nama'); }else echo "";?>" name="nama" placeholder="Nama" class="form-control"></td><td width="5%"></td>
                                               </tr>
                                               <tr>
                                                   <td ></td>
                                               ...
                                               <tr>
                                                   ...
                                                   <td ><input type="text"  value="<?php if(($this->session->userdata('r_username'))){ echo $this->session->userdata('r_username'); }else echo "";?>" name="username"  placeholder="Min 5 Characters" class="form-control"></td>
                                               </tr>
                                               <tr>
                                                   <td ></td>
                                               ...
                                               <tr>
                                                   ...
                                                   <td ><input type="email"  value="<?php if(($this->session->userdata('r_email'))){ echo $this->session->userdata('r_email'); }else echo "";?>" name="email"  placeholder="Use '@' and '.' " class="form-control"></td>
                                               </tr>
                                                    <tr>
                                                   <td ></td>
                                                   <td > <?php echo $this->session->flashdata('message7');?></td>
                                               </tr>
                                               <tr>
                                                 <td  class="kirri">Password</td>
                                                 <td ><input type="Password" value="<?php if(($this->session->userdata('r_password'))){ echo $this->session->userdata('r_password'); }else echo "";?>" name="password"  placeholder="Min 5 | Max 15 Characters" class="form-control"></td>
                                               </tr>
                                               <tr>
                                                 <td ></td>
                                               ...
                                               <tr>
                                                 ...
                                                 <td ><input type="text" value="<?php if(($this->session->userdata('r_telepon'))){ echo $this->session->userdata('r_telepon'); }else echo "";?>" name="telepon" placeholder="Max 12 Number" class="form-control">
                                                 </td>
                                               </tr>
                                                <tr>
                                                   <td ></td>
                                               ...
                                               <tr>
                                                 ...
                                                 <td ><input type="text" value="<?php if( ($this->session->userdata('r_instansi'))){ echo $this->session->userdata('r_instansi'); } else echo "";?>" name="instansi" placeholder="Nama Instansi" class="form-control"> </td>
                                               </tr>
                                               <tr>
                                                 <td ></td>
                                               ...
                                               <tr>
                                                 ...
                                                 <td ><textarea  type="text" name="alamat" placeholder="Min 5 Characters" class="form-control"><?php if( ($this->session->userdata('r_alamat'))){ echo $this->session->userdata('r_alamat'); }else echo "";?></textarea></td>
                                               </tr>
                                               <tr>
                                                 <td ></td>
