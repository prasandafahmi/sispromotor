                      ...
                      <br>
                        <div class="table-responsive">
                         ...
                         <table class="table table-striped table-advance table-hover">
                             <form action="<?php echo site_url(); ?>/administrasi/Pemesanan2/validasi/<?php echo $p[0]->id_order;?>"> 
...
?>     <tr>   
        ...
        <tr> 
          ...
          <?php if($p->pelaksana==""){echo ""; }else{?>  <td><?php echo $p->pelaksana; ?></td><?php }?>
                     ...
                     <tr>
                         <?php if(! empty($p->status_pemesanan)){?>
                         <td colspan="3"> <a href="<?php echo site_url();?>/administrasi/Apemesanan2">Kembali</a>
                         </td>
                         <?php }else{?>
