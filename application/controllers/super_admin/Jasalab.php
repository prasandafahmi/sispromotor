<?php
	class Jasalab extends CI_Controller{
        //properti
        public $table_sumber;
		...
		public function index(){
           ...
           $data['menunya'] = $this->Crud_m->selectJasaLab();
           ...
           $data['super_jasalab'] = $this->Crud_m->selectJasaLab()->num_rows();
			...
			$this->load->view('super_admin/jasalab_view', $data);
		}
        ...
        public function update($id){
           ...
           $data['super_jasalab'] = $this->Crud_m->selectJasaLab()->num_rows();
            ...
            $this->load->view('super_admin/ulab_v',$data);
        }
