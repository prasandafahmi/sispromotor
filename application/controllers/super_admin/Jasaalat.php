<?php
	...
	class Jasaalat extends CI_Controller{
        //properti
        public $table_sumber;
		...
		public function index(){
           ...
           $data['menunya'] = $this->Crud_m->selectJasaAlat();
           ...
           $data['super_jasalab'] = $this->Crud_m->selectJasaLab()->num_rows();
			...
			$this->load->view('super_admin/jasaalat_view', $data);
		}
		...
		$this->upload->initialize($config);
			...
			"syarat"=>$this->input->post('f4'),
			"harga"=>$this->input->post('f5'),
                        "kategori"=>'Jasa Alat',
			"foto"=>$gbr['file_name']
		);

		$this->Crud_m->input_data($data,$this->table_sumber);
		redirect('super_admin/Jasaalat');
		}
		}
		}
         public function update($id){
           ...
           $data['super_jasalab'] = $this->Crud_m->selectJasaLab()->num_rows();
            ...
            $this->load->view('super_admin/ualat_v',$data);
        }
